...
_address_mapping_info = _analysis.address_mapping_info
_group_registers = _analysis.group_registers
_hex_or_none = _analysis.hex_or_none
_parse_checksec = _analysis.parse_checksec
_parse_disassembly = _analysis.parse_disassembly
_parse_elf_header = _analysis.parse_elf_header
_parse_gdb_symbols = _analysis.parse_gdb_symbols
_parse_int = _analysis.parse_int
_parse_mappings = _analysis.parse_mappings
_parse_readelf_relocations = _analysis.parse_readelf_relocations
_parse_sections = _analysis.parse_sections
_read_memory_contents = _analysis.read_memory_contents
_register_rows = _analysis.register_rows
_source_context = _analysis.source_context
